...
function set-script-source-paths
{
  ...
  # :Configure: Modify this according to the location of resource file in the real project where scripts will be added.  This file begins as empty resource file generated by `new ResourceWriter()`
  #             Use Empty.resources as a reset/starting point.
  $global:ResourceFilePath = "$global:SolutionRootDir\Migrator\DatabaseMigration\DatabaseMigrationScripts.resources"
}
