...
namespace DatabaseMigration
{
    ...
    /// <summary>
    /// List of scripts that contained schema changes during a migration run.
    /// </summary>
    public interface ISchemaChangingScripts
    {
    ...
    internal static class SchemaChangeDetection
    {
        ...
        internal static bool SchemaChanged(Server server, string sql, IStartupLogger log)
        {
            ...
            server.ConnectionContext.ExecuteNonQuery("set showplan_all on");
